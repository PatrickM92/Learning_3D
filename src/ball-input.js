...
export const ball_input = (() => {
    ...
    class BasicBallControllerInput extends entity.Component {
        constructor(params) {
            super();
            this._params = params;
            this._Init();
        ...
        _onMouseUp(event) {
            console.log("ball-input _onMouseUp");
    ...
    return {
        BasicBallControllerInput: BasicBallControllerInput,
